...
トップページ (/)
    │
    ├─→ 個人ログイン (/student/login) [ウォレット接続]
    │       │
    │       └─→ 個人トップ (/student)
    │               │
    │               ├─→ 所持NFT一覧 (/student/nfts)
    │               │       └─→ 各NFT確認 (/student/nft/:id)
    │               │
    │               ├─→ NFT獲得イベント一覧 (/student/events)
    │               │       └─→ 各NFT獲得イベント応募 (/student/events/:id/apply)
    │               │
    ...
    │               │
    │               ├─→ VC管理画面 (/student/settings) [任意]
    │               │
    │               ├─→ マイページ (/student/mypage)
    │               │
    │               └─→ ゼロ知識証明 (/student/zk-proof)
    │
    └─→ 個人初回登録（ウォレット接続のみ、登録ページなし）
            └─→ 個人トップ (/student)
                    └─→ VC管理画面 (/student/settings) [任意]
```
...
トップページ (/)
    ...
    │               │       └─→ 各NFT確認 (/org/nft/:id)
    │               │
    │               ├─→ NFT発行イベント (/org/events)
    │               │       └─→ NFT発行イベント共同オファー (/org/events/:id/collaborate)
    │               │
    ...
    │               │                       └─→ メッセージ (/org/messages)
    │               │
    │               ├─→ 企業情報設定 (/org/settings) [任意]
    │               │
    │               └─→ スタンプ発行 (/org/stamp-issuance)
    │
    └─→ 企業初回登録（ウォレット接続のみ、登録ページなし）
            └─→ 企業情報設定 (/org/settings?firstTime=true) [任意]
                    └─→ 企業トップ (/org)
```
